...
export class CryptoboxCRUDStore implements ProteusSession.PreKeyStore {
  ...
  public async delete_all(): Promise<boolean> {
   ...
   * @return Resolves with the "ID" from the record, which has been deleted.
   */
   ...
   * @return Resolves with the "key pair" from the local identity.
   */
   ...
   * @return Resolves with the the specified "PreKey".
   */
   ...
   * @return Resolves with the "fingerprint" from the saved local identity.
   */
   ...
   * @return Resolves with the "ID" from the saved PreKey record.
   */
   ...
   * @return Resolves with the saved session.
   */
   ...
   * @return Resolves with the the specified "session".
   */
